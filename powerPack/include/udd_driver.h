...
#define BUTTON_PROC				0

#define FLASH_RUN               1
#define	SCALAR_TEST				1
#define USE_GRAPH				1	// CCS-C graphic ���� 

#define	AUTO_TUNING_TEST		1
#define	SL_VECTOR_TEST			1
#define	VECTOR_TEST				1
#define USE_VECTOR_CODE			1
#define USE_ROM_TEST			1	//

#define HYD_UNIT				1	// ���� ��Ʈ��
#define USE_TEST_RUN			1	// vector test routine

#define	USE_DAC_OUT				0

#define TEST_ADC_CENTER			0
#define INIT_POWER_USE_PWM		0
#define USE_VF_SPEED_CONTROL	0
//=======================================
...
#define EEPROM_RW_DELAY			5		// 2010.02.23
