...
typedef enum
{
    ...
    SCI_FIFO_TX1  = 0x0001U, // Transmit interrupt 1/15 full
    SCI_FIFO_TX2  = 0x0002U, // Transmit interrupt 2/15 full
    SCI_FIFO_TX3  = 0x0003U, // Transmit interrupt 3/15 full
    SCI_FIFO_TX4  = 0x0004U, // Transmit interrupt 4/15 full
    SCI_FIFO_TX5  = 0x0005U, // Transmit interrupt 5/15 full
    SCI_FIFO_TX6  = 0x0006U, // Transmit interrupt 6/15 full
    SCI_FIFO_TX7  = 0x0007U, // Transmit interrupt 7/15 full
    SCI_FIFO_TX8  = 0x0008U, // Transmit interrupt 8/15 full
    SCI_FIFO_TX9  = 0x0009U, // Transmit interrupt 9/15 full
    SCI_FIFO_TX10 = 0x000AU, // Transmit interrupt 10/15 full
    SCI_FIFO_TX11 = 0x000BU, // Transmit interrupt 11/15 full
    SCI_FIFO_TX12 = 0x000CU, // Transmit interrupt 12/15 full
    SCI_FIFO_TX13 = 0x000DU, // Transmit interrupt 13/15 full
    SCI_FIFO_TX14 = 0x000EU, // Transmit interrupt 14/15 full
    SCI_FIFO_TX15 = 0x000FU  // Transmit interrupt full
} SCI_TxFIFOLevel;
...
typedef enum
{
    ...
    SCI_FIFO_RX1  = 0x0001U, // Receive interrupt 1/15 full
    SCI_FIFO_RX2  = 0x0002U, // Receive interrupt 2/15 full
    SCI_FIFO_RX3  = 0x0003U, // Receive interrupt 3/15 full
    SCI_FIFO_RX4  = 0x0004U, // Receive interrupt 4/15 full
    SCI_FIFO_RX5  = 0x0005U, // Receive interrupt 5/15 full
    SCI_FIFO_RX6  = 0x0006U, // Receive interrupt 6/15 full
    SCI_FIFO_RX7  = 0x0007U, // Receive interrupt 7/15 full
    SCI_FIFO_RX8  = 0x0008U, // Receive interrupt 8/15 full
    SCI_FIFO_RX9  = 0x0009U, // Receive interrupt 9/15 full
    SCI_FIFO_RX10 = 0x000AU, // Receive interrupt 10/15 full
    SCI_FIFO_RX11 = 0x000BU, // Receive interrupt 11/15 full
    SCI_FIFO_RX12 = 0x000CU, // Receive interrupt 12/15 full
    SCI_FIFO_RX13 = 0x000DU, // Receive interrupt 13/15 full
    SCI_FIFO_RX14 = 0x000EU, // Receive interrupt 14/15 full
    SCI_FIFO_RX15 = 0x000FU  // Receive interrupt full
} SCI_RxFIFOLevel;
...
//! The \e parity parameter must be one of \b SCI_CONFIG_PAR_NONE,
//! \b SCI_CONFIG_PAR_EVEN, \b SCI_CONFIG_PAR_ODD.
//!
//! \return None.
//
//*****************************************************************************
...
SCI_getParityMode(uint32_t base)
{
    ...
    //
    return((SCI_ParityType)(HWREGH(base + SCI_O_CCR) & (SCI_CONFIG_PAR_MASK)));
}
...
//! \b SCI_FIFO_RX0, \b SCI_FIFO_RX1, \b SCI_FIFO_RX2, . . . or
//! \b SCI_FIFO_RX15.
//!
...
//! level, returned as one of \b SCI_FIFO_TX0, \b SCI_FIFO_TX1,
//! \b SCI_FIFO_TX2, . . . or \b SCI_FIFO_TX15.
//! \param rxLevel is a pointer to storage for the receive FIFO interrupt
//! level, returned as one of \b SCI_FIFO_RX0, \b SCI_FIFO_RX1,
//! \b SCI_FIFO_RX2, . . . or \b SCI_FIFO_RX15.
//!
              ...
              uint32_t *config)
{
    ...
    //
    *baud = lspclkHz / ((1U + (HWREGH(base + SCI_O_HBAUD) << 8U) |
...
//! \param base is the base address of the SCI port.
//!
//! Sets the SCIEN, TXE, and RXE bits, and enables the transmit and receive.
//!
//! \return None.
//
//*****************************************************************************
...
SCI_enableFIFO(uint32_t base)
{
    ...
    // Enable the FIFO.
    //
    HWREGH(base + SCI_O_FFTX) |= SCI_FFTX_SCIFFENA | SCI_FFTX_TXFIFOXRESET;
...
SCI_resetTxFIFO(uint32_t base)
{
    ...
    // Reset the specified FIFO.
    //
    HWREGH(base + SCI_O_FFTX) &= ~SCI_FFTX_TXFIFOXRESET;
    HWREGH(base + SCI_O_FFTX) |= SCI_FFTX_TXFIFOXRESET;
}
...
//! \b SCI_FIFO_EMPTY, \b SCI_FIFO_WORD1, \b SCI_FIFO_WORD2, \b SCI_FIFO_WORD3
//! \b SCI_FIFO_WORD4, ..., or \b SCI_FIFO_WORD16
//
//*****************************************************************************
...
//! is next read.
//!
//! \return Returns a logical OR combination of the receiver status flags,
...
SCI_getOverflowStatus(uint32_t base)
{
    ...
    //
    // Get the current FIFO overflow status
    //
...
//!
//! The \e config parameter is the logical OR of three values: the number of
...
//!
//! - \b SCI_INT_OE - Overrun Error interrupt
//! - \b SCI_INT_BE - Break Error interrupt
//! - \b SCI_INT_PE - Parity Error interrupt
//! - \b SCI_INT_FE - Framing Error interrupt
//! - \b SCI_INT_RT - Receive Timeout interrupt
//! - \b SCI_INT_TX - Transmit interrupt
//! - \b SCI_INT_RX - Receive interrupt
//! - \b SCI_INT_DSR - DSR interrupt
//! - \b SCI_INT_DCD - DCD interrupt
//! - \b SCI_INT_CTS - CTS interrupt
//! - \b SCI_INT_RI - RI interrupt
//!
//! \return None.
//
//*****************************************************************************
