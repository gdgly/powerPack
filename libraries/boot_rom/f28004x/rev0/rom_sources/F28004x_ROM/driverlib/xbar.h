...
#define XBAR_SYNCSELECT_SYNCIN_M  XBAR_SYNCSELECT_EPWM4SYNCIN_M
...
// XBar_enableExtADCSOCSource() and XBar_disableExtADCSOCSource().
//
//*****************************************************************************
#define XBAR_ADCSOC_SRC_PWM1SOCA    0x00000001U //!< ePWM1 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM2SOCA    0x00000002U //!< ePWM2 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM3SOCA    0x00000004U //!< ePWM3 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM4SOCA    0x00000008U //!< ePWM4 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM5SOCA    0x00000010U //!< ePWM5 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM6SOCA    0x00000020U //!< ePWM6 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM7SOCA    0x00000040U //!< ePWM7 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM8SOCA    0x00000080U //!< ePWM8 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM9SOCA    0x00000100U //!< ePWM9 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM10SOCA   0x00000200U //!< ePWM10 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM11SOCA   0x00000400U //!< ePWM11 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM12SOCA   0x00000800U //!< ePWM12 SOCA for ADCSOCAO
#define XBAR_ADCSOC_SRC_PWM1SOCB    0x00010000U //!< ePWM1 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM2SOCB    0x00020000U //!< ePWM2 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM3SOCB    0x00040000U //!< ePWM3 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM4SOCB    0x00080000U //!< ePWM4 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM5SOCB    0x00100000U //!< ePWM5 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM6SOCB    0x00200000U //!< ePWM6 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM7SOCB    0x00400000U //!< ePWM7 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM8SOCB    0x00800000U //!< ePWM8 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM9SOCB    0x01000000U //!< ePWM9 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM10SOCB   0x02000000U //!< ePWM10 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM11SOCB   0x04000000U //!< ePWM11 SOCB for ADCSOCBO
#define XBAR_ADCSOC_SRC_PWM12SOCB   0x08000000U //!< ePWM12 SOCB for ADCSOCBO
...
//! XBar_setSyncInputConfig().
//
//*****************************************************************************
typedef enum
{
    XBAR_SYNC_IN_EPWM4      = 0,     //!< Sync input to ePWM 4
    XBAR_SYNC_IN_EPWM7      = 3,     //!< Sync input to ePWM 7
    XBAR_SYNC_IN_EPWM10     = 6,     //!< Sync input to ePWM 10
    XBAR_SYNC_IN_ECAP1      = 9,     //!< Sync input to eCAP 1
    XBAR_SYNC_IN_ECAP4      = 12,    //!< Sync input to eCAP 4
    XBAR_SYNC_IN_ECAP7      = 15     //!< Sync input to eCAP 7
} XBar_SyncInput;

//*****************************************************************************
//
//! The following values define the \e syncSrc parameter for
//! XBar_setSyncInputConfig(). Note that some of these are only valid for
...
typedef enum
{
    XBAR_SYNC_IN_SRC_EPWM1SYNCOUT,  //!< Valid for all values of syncInput
    XBAR_SYNC_IN_SRC_EPWM4SYNCOUT,
    XBAR_SYNC_IN_SRC_EPWM7SYNCOUT,
    XBAR_SYNC_IN_SRC_EPWM10SYNCOUT,
    XBAR_SYNC_IN_SRC_ECAP1SYNCOUT,
    XBAR_SYNC_IN_SRC_EXTSYNCIN1,    //!< Valid for all values of syncInput
    XBAR_SYNC_IN_SRC_EXTSYNCIN2,    //!< Valid for all values of syncInput
    XBAR_SYNC_IN_SRC_ECAP4SYNCOUT
} XBar_SyncInputSource;

//*****************************************************************************
//
//! The following values define the \e syncSrc parameter for
//! XBar_setSyncOutputConfig().
//
//*****************************************************************************
typedef enum
{
    XBAR_SYNC_OUT_SRC_EPWM1SYNCOUT,
    XBAR_SYNC_OUT_SRC_EPWM4SYNCOUT,
    XBAR_SYNC_OUT_SRC_EPWM7SYNCOUT,
    XBAR_SYNC_OUT_SRC_EPWM10SYNCOUT
} XBar_SyncOutputSource;
...
XBar_getOutputLatchStatus(XBar_OutputNum output)
{
    ...
    //
    if((HWREGH(OUTPUTXBAR_BASE + XBAR_O_OUTPUTLATCH) &
...
XBar_clearOutputLatch(XBar_OutputNum output)
{
    ...
    HWREGH(OUTPUTXBAR_BASE + XBAR_O_OUTPUTLATCHCLR) |=
        (uint32_t)0x1U << ((uint16_t)output / 2U);
}
...
//! should be passed a value of \b XBAR_SYNC_IN_XXXX, where XXXX is the ePWM or
//! eCAP instance the sync signal is entering.
//!
//! The \e syncSrc parameter is the sync signal selected as the source of the
//! sync input. It should be passed a value of \b XBAR_SYNC_IN_SRC_XXXX, where
//! XXXX is a sync signal coming from an ePWM, eCAP or external sync output.
//! For example, a \e syncInput value of \b XBAR_SYNC_IN_ECAP1 and a
//! \e syncSrc value of \b XBAR_SYNC_IN_SRC_EPWM1SYNCOUT will make the
//! EPWM1SYNCOUT signal drive eCAP1's SYNCIN signal.
//!
//! Note that some \e syncSrc values are only valid for certain values of
//! \e syncInput. See device technical reference manual for info on time-base
//! counter synchronization for details.
//!
//! \return None.
//
//*****************************************************************************
static inline void
XBar_setSyncInputConfig(XBar_SyncInput syncInput, XBar_SyncInputSource syncSrc)
{
    uint32_t clearMask;

    clearMask = (uint32_t)XBAR_SYNCSELECT_SYNCIN_M << (uint32_t)syncInput;

    //
    // Write the input sync source selection to the appropriate register.
    //
    EALLOW;
    HWREG(TRIGXBAR_BASE + XBAR_O_SYNCSELECT) =
        (HWREG(TRIGXBAR_BASE + XBAR_O_SYNCSELECT) & ~clearMask) |
...
//! \e syncSrc parameter is a value \b XBAR_SYNC_OUT_SRC_XXXX, where XXXX is a
//! sync signal coming from an ePWM such as XBAR_SYNC_OUT_SRC_EPWM1SYNCOUT
//!
//! \return None.
//
//*****************************************************************************
static inline void
XBar_setSyncOutputConfig(XBar_SyncOutputSource syncSrc)
{
    //
    ...
    HWREG(TRIGXBAR_BASE + XBAR_O_SYNCSELECT) =
        (HWREG(TRIGXBAR_BASE + XBAR_O_SYNCSELECT) &
         ~((uint32_t)XBAR_SYNCSELECT_SYNCOUT_M)) |
        ((uint32_t)syncSrc << XBAR_SYNCSELECT_SYNCOUT_S);
    EDIS;
}

//*****************************************************************************
//
//! Enables ePWM SOC signals to drive an external ADCSOC signal.
//!
...
//! of \b XBAR_ADCSOC_SRC_PWMxSOCA/B values that correspond to different
//! signals.
//!
//! \return None.
//
//*****************************************************************************
static inline void
XBar_enableExtADCSOCSource(uint32_t adcsocSrc)
{
    //
    // Set the bits that correspond to signal to be enabled.
    //
    EALLOW;
    HWREG(TRIGXBAR_BASE + XBAR_O_EXTADCSOCSELECT) |= adcsocSrc;
    EDIS;
}
...
//! OR of \b XBAR_ADCSOC_SRC_PWMxSOCA/B values that correspond to different
//! signals.
//!
//! \return None.
//
//*****************************************************************************
static inline void
XBar_disableExtADCSOCSource(uint32_t adcsocSrc)
{
    //
...
//*****************************************************************************
static inline void
XBar_lockSOCSelect(void)
{
    //
    // Lock the EXTADCSOCSELECT bit of the SYNCSOCLOCK register.
    //
    EALLOW;
    HWREG(TRIGXBAR_BASE + XBAR_O_SYNCSOCLOCK) =
        XBAR_SYNCSOCLOCK_EXTADCSOCSELECT;
    EDIS;
}
...
//*****************************************************************************
static inline void
XBar_lockSyncSelect(void)
{
    //
    // Lock the EXTADCSOCSELECT bit of the SYNCSOCLOCK register.
    //
    EALLOW;
    HWREG(TRIGXBAR_BASE + XBAR_O_SYNCSOCLOCK) = XBAR_SYNCSOCLOCK_SYNCSELECT;
    EDIS;
}
