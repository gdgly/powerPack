...
//*****************************************************************************
//
//! Values that can be passed to GPIO_setPadConfig() as the \e qualification
//! parameter and returned by GPIO_getPadConfig().
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
//! Values that can be passed to GPIO_setInterruptPin() and
//! GPIO_setInterruptType(), GPIO_enableInterrupt(), GPIO_disableInterrupt(),
//! as the \e extIntNum parameter, and returned by GPIO_getInterruptType() in
//! the \e *extIntNum parameter.
//
//*****************************************************************************
typedef enum
{
...
GPIO_readPin(uint32_t pin)
{
    ...
    gpioDataReg = (uint32_t *)GPIODATA_BASE +
                  ((pin / 32) * GPIO_DATA_REGS_STEP);

    pinVal = (gpioDataReg[GPIO_GPxDAT_INDEX] >> (pin % 32)) & (uint32_t)0x1U;
