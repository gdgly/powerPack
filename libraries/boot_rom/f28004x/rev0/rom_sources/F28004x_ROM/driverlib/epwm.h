...
// prescaler and highSpeedPrescaler parameter.
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
// Values that can be passed to EPWM_setSyncOutPulseMode() as the mode
// parameter
//
//*****************************************************************************
typedef enum
{
    //! sync pulse is generated by software or by EPWMxSYNCI
...
//*****************************************************************************
//
// Values that can be passed to the EPWM_setupEPWMLinks()  as epwmLink
// parameter
//
//*****************************************************************************
typedef enum
...
//*****************************************************************************
//
// Values that can be passed to the EPWM_setupEPWMLinks() as linkComp
// parameter
//
//*****************************************************************************
typedef enum
{
    ...
    EPWM_LINK_GLVCTL2 = 28  //!< link GLDCTL2 registers
}EPWM_LinkComponent;
...
typedef enum
{
    ...
    EPWM_COMP_LOAD_ON_CNTER_ZERO = 0,
    //! load when counter equals period
    EPWM_COMP_LOAD_ON_CNTER_PERIOD = 1,
    //! load when counter equals zero or period
    EPWM_COMP_LOAD_ON_CNTER_ZERO_PERIOD = 2,
    //! Freeze shadow to active load
    EPWM_COMP_LOAD_FREEZE = 3,
    //! load when counter equals zero
    EPWM_COMP_LOAD_ON_SYNC_CNTER_ZERO = 4,
    //! load when counter equals period
    EPWM_COMP_LOAD_ON_SYNC_CNTER_PERIOD = 5,
    //! load when counter equals zero or period
    EPWM_COMP_LOAD_ON_SYNC_CNTER_ZERO_PERIOD = 6,
    //! load on sync only
...
//*****************************************************************************
//
// Values that can be passed to the EPWM_setActionQualifierShadowLoadMode()
// as the aqModule parameter
//
//*****************************************************************************
typedef enum
{
...
{
    //! load when counter equals zero
    EPWM_AQ_LOAD_ON_CNTER_ZERO = 0,
    //! load when counter equals period
    EPWM_AQ_LOAD_ON_CNTER_PERIOD = 1,
    //! load when counter equals zero or period
    EPWM_AQ_LOAD_ON_CNTER_ZERO_PERIOD = 2,
    //! Freeze shadow to active load
    EPWM_AQ_LOAD_FREEZE = 3,
    //! load when counter equals zero
    EPWM_AQ_LOAD_ON_SYNC_CNTER_ZERO = 4,
    //! load when counter equals period
    EPWM_AQ_LOAD_ON_SYNC_CNTER_PERIOD = 5,
    //! load when counter equals zero or period
    EPWM_AQ_LOAD_ON_SYNC_CNTER_ZERO_PERIOD = 6,
    //! load on sync only
...
//*****************************************************************************
//
// Values that can be passed to EPWM_setActionQualifierT2TriggerSource() and
// EPWM_setActionQualifierT2TriggerSource() as the trigger parameter.
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
// Values that can be passed to EPWM_setActionQualifierAction() as the event
// parameter.
//
//*****************************************************************************
typedef enum
...
// EPWM_setActionQualifierContSWForceAction(), EPWM_setActionQualifierAction()
...
// EPWM_setActionQualifierSwAction(),EPWM_setActionQualifierContSWForceAction()
// EPWM_setActionQualifierAction() as epwmOutput parameter.
//
//*****************************************************************************
typedef enum
{
...
typedef enum
{
    ...
    EPWM_AQ_SW_SH_LOAD_ON_CNTER_ZERO        = 0,
    //! shadow mode load when counter equals period
    EPWM_AQ_SW_SH_LOAD_ON_CNTER_PERIOD      = 1,
    //! shadow mode load when counter equals zero or period
    EPWM_AQ_SW_SH_LOAD_ON_CNTER_ZERO_PERIOD = 2
}EPWM_ActionQualifierContForce;

//*****************************************************************************
//
// Values that can be passed to the EPWM_setDeadBandOutputSwapMode()
// as the output parameter.
//
//*****************************************************************************
typedef enum
...
//*****************************************************************************
//
// Values that can be passed to the EPWM_setDeadBandDelayPolarity(),
// EPWM_setDeadBandDelayMode() as the delayMode parameter.
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
// Values that can be passed to the EPWM_setRisingEdgeDeadBandDelayInput(),
// EPWM_setFallingEdgeDeadBandDelayInput() s as the input parameter.
//
//*****************************************************************************
...
//*****************************************************************************
//
// Values that can be passed to and EPWM_setDeadBandControlShadowLoadMode() as
// the loadMode parameter.
//
//*****************************************************************************
typedef enum
{
    //! load when counter equals zero
    EPWM_DB_LOAD_ON_CNTER_ZERO        = 0,
    //! load when counter equals period
    EPWM_DB_LOAD_ON_CNTER_PERIOD      = 1,
    //! load when counter equals zero or period
    EPWM_DB_LOAD_ON_CNTER_ZERO_PERIOD = 2,
    //! Freeze shadow to active load
...
// as the loadMode parameter.
//
//*****************************************************************************
typedef enum
{
    //! load when counter equals zero
    EPWM_RED_LOAD_ON_CNTER_ZERO        = 0,
    //! load when counter equals period
    EPWM_RED_LOAD_ON_CNTER_PERIOD      = 1,
    //! load when counter equals zero or period
    EPWM_RED_LOAD_ON_CNTER_ZERO_PERIOD = 2,
    //! Freeze shadow to active load
...
{
    //! load when counter equals zero
    EPWM_FED_LOAD_ON_CNTER_ZERO        = 0,
    //! load when counter equals period
    EPWM_FED_LOAD_ON_CNTER_PERIOD      = 1,
    //! load when counter equals zero or period
    EPWM_FED_LOAD_ON_CNTER_ZERO_PERIOD = 2,
    //! Freeze shadow to active load
...
//*****************************************************************************
//
// Values that can be passed to and EPWM_setDeadBandCounterClock() as the
// clockMode parameter.
//
//*****************************************************************************
typedef enum
...
//*****************************************************************************
//
// Values that can be passed to EPWM_setTripZoneAction() as the tzEvent
// parameter.
//
//*****************************************************************************
typedef enum
...
//*****************************************************************************
//
// Values that can be passed to and EPWM_setTripZoneAction() as the tzAction
// parameter.
//
//*****************************************************************************
typedef enum
...
//*****************************************************************************
//
// Values that can be passed to EPWM_setTripZoneAdvAction() as the tzAdvEvent
// parameter.
//
//*****************************************************************************
typedef enum
...
// EPWM_setTripZoneAdvDigitalCompareActionB() and
// EPWM_setTZAdvAction() as the tzAdvDcAction parameter.
//
//*****************************************************************************
typedef enum
{
    ...
    EPWM_TZ_ADV_ACTION_TOGGLE  = 3, //!< low voltage state
...
// EPWM_setTripZoneAdvDigitalCompareActionB() as the tzAdvDcEvent parameter.
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
// This value can be passed to EPWM_clearTripZoneInterruptFlag() as the
// tzInterrupt parameter. This value is returned by the
// EPWM_getTripZoneInterruptStatus()
//
//*****************************************************************************
//! Trip Zone interrupt
...
//*****************************************************************************
//
// This values can be passed to EPWM_clearCycleByCycleTripZoneInterruptFlag()
// as the tzCbcInterrupt parameter.
// These values are returned by EPWM_getCycleByCycleTripZoneInterruptStatus().
//
//*****************************************************************************
//! CBC interrupt CBC1
#define EPWM_TZ_CBC_INTERRUPT_CBC1  0x1U
//! CBC interrupt CBC2
#define EPWM_TZ_CBC_INTERRUPT_CBC2  0x2U
//! CBC interrupt CBC3
#define EPWM_TZ_CBC_INTERRUPT_CBC3  0x4U
//! CBC interrupt CBC4
#define EPWM_TZ_CBC_INTERRUPT_CBC4  0x8U
//! CBC interrupt CBC5
#define EPWM_TZ_CBC_INTERRUPT_CBC5  0x10U
//! CBC interrupt CBC6
#define EPWM_TZ_CBC_INTERRUPT_CBC6   0x20U
//! CBC interrupt Digital compare event A2
#define EPWM_TZ_CBC_INTERRUPT_DCAEVT2  0x40U
//! CBC interrupt Digital compare event B2
#define EPWM_TZ_CBC_INTERRUPT_DCBEVT2  0x80U

//*****************************************************************************
//
// This values can be passed to EPWM_clearOneShotTripZoneInterruptFlag() as the
// tzCbcInterrupt parameter. These values are returned by the
// EPWM_getOneShotTripZoneInterruptStatus() .
//
//*****************************************************************************
//! OST interrupt CBC1
#define EPWM_TZ_OST_INTERRUPT_OST1  0x1U
//! OST interrupt CBC2
#define EPWM_TZ_OST_INTERRUPT_OST2  0x2U
//! OST interrupt CBC3
#define EPWM_TZ_OST_INTERRUPT_OST3  0x4U
//! OST interrupt CBC4
#define EPWM_TZ_OST_INTERRUPT_OST4  0x8U
//! OST interrupt CBC5
#define EPWM_TZ_OST_INTERRUPT_OST5  0x10U
//! OST interrupt CBC6
#define EPWM_TZ_OST_INTERRUPT_OST6  0x20U
//! OST interrupt Digital compare event A1
#define EPWM_TZ_OST_INTERRUPT_DCAEVT1   0x40U
//! OST interrupt Digital compare event B1
#define EPWM_TZ_OST_INTERRUPT_DCBEVT1   0x80U

//*****************************************************************************
//
// Values that can be passed to EPWM_selectCycleByCycleTripZoneClearEvent() as
// the clearMode parameter.
//
//*****************************************************************************
typedef enum
{
...
// EPWM_forceADCTrigger() as the adcSocType parameter
//
//*****************************************************************************
typedef enum
{
...
// EPWM_disableDigitalCompareTripCombinationInput() as the dcType parameter.
//
//*****************************************************************************
typedef enum
{
...
// or EPWM_disableDigitalCompareTripCombinationInput() as the tripInput
// parameter.
//
//*****************************************************************************
...
// EPWM_setDigitalCompareEventSyncMode(),EPWM_enableDigitalCompareADCTrigger(),
// EPWM_disableDigitalCompareADCTrigger(), EPWM_enableDigitalCompareSyncEvent()
// EPWM_disableDigitalCompareSyncEvent() as the dcModule parameter.
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
// Values that can be passed to the loadPulse variable of
// EPWM_setGlobalShadowLoadPulse() function
//
//*****************************************************************************
typedef enum
{
    //! load when counter is equal to zero
    EPWM_GL_LOAD_PULSE_CNTER_ZERO = 0x0,
    //! load when counter is equal to period
    EPWM_GL_LOAD_PULSE_CNTER_PERIOD = 0x1,
    //! load when counter is equal to zero or period
    EPWM_GL_LOAD_PULSE_CNTER_ZERO_PERIOD = 0x2,
    //! load on sync event
    EPWM_GL_LOAD_PULSE_SYNC = 0x3,
    //! load on sync event or when counter  is equal to zero
    EPWM_GL_LOAD_PULSE_SYNC_OR_CNTER_ZERO = 0x4,
    //! load on sync event or when counter  is equal to period
    EPWM_GL_LOAD_PULSE_SYNC_OR_CNTER_PERIOD = 0x5,
    //! load on sync event or when counter is equal to period or zero
    EPWM_GL_LOAD_PULSE_SYNC_CNTER_ZERO_PERIOD = 0x6,
...
//*****************************************************************************
//
// Values that can be passed to EPWM_enableGlobalLoadRegisters() or
// EPWM_disableGlobalLoadRegisters() as the loadRegister parameter.
//
//*****************************************************************************
...
//*****************************************************************************
//
// Values that can be passed to EPWM_setValleyTriggerSource() as the trigger
// parameter.
//
//*****************************************************************************
typedef enum
{
    ...
    EPWM_VALLEY_TRIGGER_EVENT_CNTER_ZERO = 1U,
    //! Valley capture trigged by when counter is equal period.
    EPWM_VALLEY_TRIGGER_EVENT_CNTER_PERIOD = 2U,
    //! Valley capture trigged when counter is equal to zero or period.
    EPWM_VALLEY_TRIGGER_EVENT_CNTER_ZERO_PERIOD = 3U,
...
//*****************************************************************************
//
// Values that can be passed to EPWM_getValleyCountEdgeStatus() as the edge
// parameter.
//
//*****************************************************************************
typedef enum
...
//*****************************************************************************
//
// Values that can be passed to EPWM_setValleyDelayValue() as the delayMode
// parameter.
//
//*****************************************************************************
typedef enum
...
//*****************************************************************************
//
// Values that can be passed to EPWM_lockRegisters() as the registerGroup
// parameter.
//
//*****************************************************************************
typedef enum
{
    EPWM_REGISTER_GROUP_GLOBAL_LOAD = 1,     //!< Global load register group
    EPWM_REGISTER_GROUP_TRIP_ZONE = 2,       //!< Trip zone register group
    EPWM_REGISTER_GROUP_TRIP_ZONE_CLEAR = 3, //!< Trip zone clear group
    EPWM_REGISTER_GROUP_DIGITAL_COMPARE = 4  //!< Digital compare group
                                              ...
                                              EPWM_SyncCountMode mode)
{
    ...
    if((uint16_t)mode == EPWM_COUNT_MODE_UP_AFTER_SYNC)
    {
        // set PHSDIR bit
        HWREGH(base + EPWM_O_TBCTL) |= EPWM_TBCTL_PHSDIR;
    }
    else if((uint16_t)mode == EPWM_COUNT_MODE_DOWN_AFTER_SYNC)
    {
        // clear PHSDIR bit
        HWREGH(base + EPWM_O_TBCTL) &= ~EPWM_TBCTL_PHSDIR;
    }
...
//! Valid values for prescaler and highSpeedPrescaler are EPWM_CLOCK_DIVIDER_X,
...
//!   TBCLK = SYSCLKOUT/(highSpeedPrescaler * prescaler)
//!
//!
//! \return None.
//
...
static inline void EPWM_setClockPrescaler(uint32_t base,
                                          ...
                                          EPWM_ClockDivider highSpeedPrescaler)
{
    ASSERT(EPWM_isBaseValid(base));
...
//
//*****************************************************************************
static inline void EPWM_swForceSyncPulse(uint32_t base)
{
    ASSERT(EPWM_isBaseValid(base));
                                          ...
                                          EPWM_PeriodLoadMode loadMode)
{
    ...
    if((uint16_t)loadMode == EPWM_PERIOD_SHADOW_LOAD)
    {
        // clear PRDLD
...
//
//*****************************************************************************
static inline uint16_t EPWM_getSyncStatus(uint32_t base)
{
    ASSERT(EPWM_isBaseValid(base));
...
static inline void EPWM_setPhaseShift(uint32_t base, uint16_t phaseCount)
{
    ...
    HWREG(base + EPWM_O_TBPHS) =
                   ((HWREG(base + EPWM_O_TBPHS) & ~EPWM_TBPHS_TBPHS_M) |
...
//!   - EPWM_LINK_GLVCTL2  - link GLDCTL2 registers
//!
//! \return None.
//
//*****************************************************************************
static inline void EPWM_setupEPWMLinks(uint32_t base, EPWM_Link epwmLink,
                                        EPWM_LinkComponent linkComp)
{
    ASSERT(EPWM_isBaseValid(base));

    // Configure EPWMM links
...
//! \param enableShadowLoad is the shadow load mode flag.
//!
//! This function sets up the counter compare shadow load mode. Valid
...
//!  - loadMode
//!      - EPWM_COMP_LOAD_ON_CNTER_ZERO - load when counter equals zero
//!      - EPWM_COMP_LOAD_ON_CNTER_PERIOD - load when counter equals period
//!      - EPWM_COMP_LOAD_ON_CNTER_ZERO_PERIOD - load when counter equals
//!                                               zero or period
//!      - EPWM_COMP_LOAD_FREEZE  - Freeze shadow to active load
//!      - EPWM_COMP_LOAD_ON_SYNC_CNTER_ZERO - load when counter equals zero
//!      - EPWM_COMP_LOAD_ON_SYNC_CNTER_PERIOD -load when counter equals period
//!      - EPWM_COMP_LOAD_ON_SYNC_CNTER_ZERO_PERIOD - load when counter equals
//!                                                   zero or period
//!      - EPWM_COMP_LOAD_ON_SYNC_ONLY - load on sync only
//!  - enableShadowLoad
//!      - true  - Enable shadow load mode.
//!      - false - Disable shadow load-immediate load only.
//!
//! \return None.
//
//*****************************************************************************
                                ...
                                bool enableShadowLoad)
{
    ...
    if(((uint16_t)compModule == EPWM_COUNTER_COMPARE_A) ||
       ((uint16_t)compModule == EPWM_COUNTER_COMPARE_C))
    {
        syncModeOffset = 10U;
        loadModeOffset = 0U;
        shadowModeOffset = 4U;
    }
    else if(((uint16_t)compModule == EPWM_COUNTER_COMPARE_B) ||
            ((uint16_t)compModule == EPWM_COUNTER_COMPARE_D))
    {
        syncModeOffset = 12U;
        loadModeOffset = 2U;
        shadowModeOffset = 6U;
    ...
    registerOffset = base + EPWM_O_CMPCTL + ((uint16_t)compModule & 0x1U);

    // If shadow load mode is enabled
    if(enableShadowLoad)
    {
                                 ...
                                 uint16_t compCount)
{
    ...
    if(((uint16_t)compModule == EPWM_COUNTER_COMPARE_A) ||
        ((uint16_t)compModule == EPWM_COUNTER_COMPARE_B))
    {
        // write to CMPA or COMPB bits
        HWREG(base + registerOffset) =
             ((HWREG(base + registerOffset) & (uint32_t)0x0000FFFFU) |
              ((uint32_t)compCount << 16U));
    }
    else if(((uint16_t)compModule == EPWM_COUNTER_COMPARE_C) ||
            ((uint16_t)compModule == EPWM_COUNTER_COMPARE_D))
    {
...
//
//*****************************************************************************
static inline uint16_t EPWM_getCounterCompareShadowStatus(uint32_t base,
                                         EPWM_CounterCompareModule compModule)
{
    ASSERT(EPWM_isBaseValid(base));
...
//! \param enableShadowLoad is the shadow load mode flag.
//!
//! This function sets the Action Qualifier  shadow load mode. Valid
//! values for the variables are:
//!  - aqModule
//!      - EPWM_ACTION_QUALIFIER_A - Action Qualifier A.
//!      - EPWM_ACTION_QUALIFIER_B - Action Qualifier B.
//!  - loadMode
//!      - EPWM_AQ_LOAD_ON_CNTER_ZERO - load when counter equals zero
//!      - EPWM_AQ_LOAD_ON_CNTER_PERIOD - load when counter equals period
//!      - EPWM_AQ_LOAD_ON_CNTER_ZERO_PERIOD - load when counter equals
//!                                               zero or period
//!      - EPWM_AQ_LOAD_FREEZE  - Freeze shadow to active load
//!      - EPWM_AQ_LOAD_ON_SYNC_CNTER_ZERO - load when counter equals zero
//!      - EPWM_AQ_LOAD_ON_SYNC_CNTER_PERIOD -load when counter equals period
//!      - EPWM_AQ_LOAD_ON_SYNC_CNTER_ZERO_PERIOD - load when counter equals
//!                                                   zero or period
                                        ...
                                        bool enableShadowLoad)
{
    ...
    if(enableShadowLoad)
    {
        ...
        HWREGH(base  + EPWM_O_AQCTL) =
                 (( HWREGH(base  + EPWM_O_AQCTL) &
                    (~(0x3 << (uint16_t)aqModule)) | // Clear shadow load
                    (~(0x3 << (uint16_t)syncModeOffset)) | // Clear Sync load
...
//*****************************************************************************
//
//! Sets up load mode for Action qualifier software mode.
//!
//! \param base is the base address of the EPWM module.
...
//! Valid values for mode are:
//!   - EPWM_AQ_SW_SH_LOAD_ON_CNTER_ZERO        - shadow mode load when counter
//!                                               equals zero
//!   - EPWM_AQ_SW_SH_LOAD_ON_CNTER_PERIOD      - shadow mode load when counter
//!                                               equals period
//!   - EPWM_AQ_SW_SH_LOAD_ON_CNTER_ZERO_PERIOD - shadow mode load when counter
                                   ...
                                   EPWM_ActionQualifierSWOutput output)
{
    ...
    if((uint16_t)epwmOutput == EPWM_AQ_OUTPUT_A)
    {
        HWREGH(base + EPWM_O_AQCSFRC) =
                ((HWREGH(base + EPWM_O_AQCSFRC) & ~EPWM_AQCSFRC_CSFA_M) |
                 ((uint16_t)output));
    }
    else if((uint16_t)epwmOutput == EPWM_AQ_OUTPUT_B)
    {
        HWREGH(base + EPWM_O_AQCSFRC) =
                                                  ...
                                                  bool enableSwapMode)
{
    ...
    if(enableSwapMode)
    {
        ...
        HWREGH(base + EPWM_O_DBCTL) =
                      ((HWREGH(base + EPWM_O_DBCTL) & ~ mask) | mask);
    }
    else
    {
...
//*****************************************************************************
//
//! Set the Dead Band control load mode.
//!
//! \param base is the base address of the EPWM module.
//! \param enableShadowLoad is the shadow mode load flag.
//! \param loadMode is the shadow to active load mode.
//!
//! This function sets the Dead Band control register load mode.
//! Valid values for the parameters are:
//!   shadowLoadFlag
//!     - true    - Shadow load mode is enabled
//!     - false   - Immediate load mode only
//!   loadMode
//!     - EPWM_DB_LOAD_ON_CNTER_ZERO         - load when counter equals zero.
//!     - EPWM_DB_LOAD_ON_CNTER_PERIOD       - load when counter equals period.
//!     - EPWM_DB_LOAD_ON_CNTER_ZERO_PERIOD  - load when counter equals zero or
//!                                            period.
...
//*****************************************************************************
//
//! Set the RED (Rising Edge Delay)load mode.
//!
//! \param base is the base address of the EPWM module.
//! \param enableShadowLoad is the shadow mode load flag.
//! \param loadMode is the shadow to active load event.
//!
//! This function sets the Rising Edge Delay register load mode.
//! Valid values for the parameters are:
//!   enableShadowLoad
//!     - true    - Shadow load mode enabled.
//!     - false   - Immediate load mode only
//!   loadMode
//!     - EPWM_RED_LOAD_ON_CNTER_ZERO        - load when counter equals zero.
//!     - EPWM_RED_LOAD_ON_CNTER_PERIOD      - load when counter equals period.
//!     - EPWM_RED_LOAD_ON_CNTER_ZERO_PERIOD - load when counter equals zero or
//!                                            period.
//!     - EPWM_RED_LOAD_FREEZE               - Freeze shadow to active load.
//!
//!    \b Note: The loadMode parameters are valid only if shadow mode is
//!             enabled.
//!
//! \return None.
//
...
//*****************************************************************************
//
//! Set the FED (Falling Edge Delay)load mode.
//!
//! \param base is the base address of the EPWM module.
//! \param enableShadowLoad is the shadow mode load flag.
//! \param loadMode is the shadow to active load event.
//!
//! This function sets the Falling Edge Delay register load mode.
//! Valid values for the parameters are:
//!   enableShadowLoad
//!     - true    - Shadow load mode enabled.
//!     - false   - Immediate load mode only
//!   loadMode
//!     - EPWM_FED_LOAD_ON_CNTER_ZERO        - load when counter equals zero.
//!     - EPWM_FED_LOAD_ON_CNTER_PERIOD      - load when counter equals period.
//!     - EPWM_FED_LOAD_ON_CNTER_ZERO_PERIOD - load when counter equals zero or
//!                                            period.
...
//! The value of fedCount should be less than 0x3FFF.
//!
//! \return None.
//
//*****************************************************************************
...
//! \param base is the base address of the EPWM module.
//!
//! This function enables ePAM chopper module.
//!
//! \return None.
//
//*****************************************************************************
...
//! \param base is the base address of the EPWM module.
//!
//! This function disables ePAM chopper module.
//!
//! \return None.
//
//*****************************************************************************
...
static inline void EPWM_setChopperFreq(uint32_t base, uint16_t freqDiv)
{
    ...
    HWREGH(base + EPWM_O_PCCTL) =
                    ((HWREGH(base + EPWM_O_PCCTL) & ~EPWM_PCCTL_CHPFREQ_M) |
                                                  ...
                                                  uint16_t firstPulseWidth)
{
    ...
    // Set the chopper clock
    HWREGH(base + EPWM_O_PCCTL) =
              ((HWREGH(base + EPWM_O_PCCTL) & ~EPWM_PCCTL_OSHTWTH_M) |
...
static inline void EPWM_setTripZoneAdvDigitalCompareActionA(uint32_t base,
                           EPWM_TripZoneAdvDigitalComapreEvent tzAdvDcEvent,
...
{
    ASSERT(EPWM_isBaseValid(base));
    ASSERT((tzInterrupt == EPWM_TZ_INTERRUPT_CBC) ||
           (tzInterrupt == EPWM_TZ_INTERRUPT_OST) ||
           (tzInterrupt == EPWM_TZ_INTERRUPT_DCAEVT1) ||
           (tzInterrupt == EPWM_TZ_INTERRUPT_DCAEVT2) ||
           (tzInterrupt == EPWM_TZ_INTERRUPT_DCBEVT1) ||
           (tzInterrupt == EPWM_TZ_INTERRUPT_DCBEVT2));
...
//*****************************************************************************
//
//! Gets the Trip Zone interrupt status
//!
//! \param base is the base address of the EPWM module.
//!
//! This function returns the Trip Zone interrupt status.
//!
//! \return The function returns the following or the bit wise OR value
...
//
//***************************************************************************
static inline uint16_t EPWM_getTripZoneInterruptStatus(uint32_t base)
{
    ASSERT(EPWM_isBaseValid(base));
    // Return the Trip zone interrupt status
    return(HWREGH(base + EPWM_O_TZFLG) & 0x7FU);
}

//*****************************************************************************
//
//! Gets the Trip Zone Cycle by Cycle interrupt status
//!
//! \param base is the base address of the EPWM module.
//!
//! This function returns the specific Cycle by Cycle Trip Zone interrupt
//! status.
//!
//! \return The function returns the following values.
//!           - EPWM_TZ_CBC_INTERRUPT_CBC1     - CBC interrupt CBC1
//!           - EPWM_TZ_CBC_INTERRUPT_CBC2     - CBC interrupt CBC2
//!           - EPWM_TZ_CBC_INTERRUPT_CBC3     - CBC interrupt CBC3
//!           - EPWM_TZ_CBC_INTERRUPT_CBC4     - CBC interrupt CBC4
//!           - EPWM_TZ_CBC_INTERRUPT_CBC5     - CBC interrupt CBC5
//!           - EPWM_TZ_CBC_INTERRUPT_CBC6     - CBC interrupt CBC6
//!           - EPWM_TZ_CBC_INTERRUPT_DCAEVT2  - CBC interrupt Digital compare
//!                                                event A2
//!           - EPWM_TZ_CBC_INTERRUPT_DCBEVT2  - CBC interrupt Digital compare
//!                                                event B2
//
//***************************************************************************
static inline uint16_t EPWM_getCycleByCycleTripZoneInterruptStatus(uint32_t
                                                                   base)
{
    ASSERT(EPWM_isBaseValid(base));
    // Return the Cycle By Cycle Trip zone interrupt status
    return(HWREGH(base + EPWM_O_TZCBCFLG) & 0xFFU);
}

//*****************************************************************************
//
//! Gets the Trip Zone One Shot interrupt status
//!
//! \param base is the base address of the EPWM module.
//!
//! This function returns the specific One Shot Trip Zone interrupt status.
//!
//! \return The function returns the following values.
//!           - EPWM_TZ_OST_INTERRUPT_OST1     - OST interrupt OST1
//!           - EPWM_TZ_OST_INTERRUPT_OST2     - OST interrupt OST2
//!           - EPWM_TZ_OST_INTERRUPT_OST3     - OST interrupt OST3
//!           - EPWM_TZ_OST_INTERRUPT_OST4     - OST interrupt OST4
//!           - EPWM_TZ_OST_INTERRUPT_OST5     - OST interrupt OST5
//!           - EPWM_TZ_OST_INTERRUPT_OST6     - OST interrupt OST6
//!           - EPWM_TZ_OST_INTERRUPT_DCAEVT1  - OST interrupt Digital
//!                                                 compare event A1
//!           - EPWM_TZ_OST_INTERRUPT_DCBEVT1  - OST interrupt Digital
//!                                                 compare event B1
//
//***************************************************************************
static inline uint16_t EPWM_getOneShotTripZoneInterruptStatus(uint32_t base)
{
    ASSERT(EPWM_isBaseValid(base));
    // Return the One Shot Trip zone interrupt status
...
//*****************************************************************************
//
//! Clear Trip Zone interrupt flag
//!
//! \param base is the base address of the EPWM module.
//! \param tzIntFlags is the Trip Zone interrupt.
//!
//! This function clears the Trip Zone interrupt flags
//! Valid values for tzIntFlags are:
//!   - EPWM_TZ_INTERRUPT         - Global Trip Zone interrupt
//!   - EPWM_TZ_INTERRUPT_CBC     - Trip Zones Cycle By Cycle interrupt
//!   - EPWM_TZ_INTERRUPT_OST    - Trip Zones One Shot interrupt
//!   - EPWM_TZ_INTERRUPT_DCAEVT1 - Digital Compare A Event 1 interrupt
//!   - EPWM_TZ_INTERRUPT_DCAEVT2 - Digital Compare A Event 2 interrupt
...
//
//***************************************************************************
static inline void EPWM_clearTripZoneInterruptFlag(uint32_t base,
                                                   uint16_t tzIntFlags)
{
    ASSERT(EPWM_isBaseValid(base));
    ASSERT((tzIntFlags < 0x80U) && (tzIntFlags > 0x1U));

    EALLOW;
    // Clear Trip zone event flag
    HWREGH(base + EPWM_O_TZCLR) |= tzIntFlags;
    EDIS;
}

//*****************************************************************************
//
//! Clear the Trip Zone Cycle by Cycle interrupt flag.
//!
//! \param base is the base address of the EPWM module.
//! \param tzCBCIntFlags is the CBC interrupt to be cleared.
//!
//! This function clears the specific Cycle by Cycle Trip Zone interrupt flag.
//! The following are valid values for tzCBCIntFlags.
//!   - EPWM_TZ_CBC_INTERRUPT_CBC1     - CBC interrupt CBC1
//!   - EPWM_TZ_CBC_INTERRUPT_CBC2     - CBC interrupt CBC2
//!   - EPWM_TZ_CBC_INTERRUPT_CBC3     - CBC interrupt CBC3
//!   - EPWM_TZ_CBC_INTERRUPT_CBC4     - CBC interrupt CBC4
...
//
//***************************************************************************
static inline void EPWM_clearCycleByCycleTripZoneInterruptFlag(uint32_t base,
                                                 uint16_t tzCBCIntFlags)
{
    ASSERT(EPWM_isBaseValid(base));
    ASSERT(tzCBCIntFlags < 0x800U);


    EALLOW;
    // Clear the Cycle By Cycle Trip zone interrupt flag
    HWREGH(base + EPWM_O_TZCBCCLR) |= tzCBCIntFlags;
...
//*****************************************************************************
//
//! Clear the Trip Zone One Shot interrupt flag.
//!
//! \param base is the base address of the EPWM module.
//! \param tzOSTIntFlags is the OST interrupt to be cleared.
//!
//! This function clears the specific One Shot (OST) Trip Zone interrupt flag.
//! The following are valid values for tzOSTIntFlags.
//!  - EPWM_TZ_OST_INTERRUPT_OST1      - OST interrupt CBC1
//!  - EPWM_TZ_OST_INTERRUPT_OST2      - OST interrupt CBC2
//!  - EPWM_TZ_OST_INTERRUPT_OST3      - OST interrupt CBC3
//!  - EPWM_TZ_OST_INTERRUPT_OST4      - OST interrupt CBC4
//!  - EPWM_TZ_OST_INTERRUPT_OST5      - OST interrupt CBC5
//!  - EPWM_TZ_OST_INTERRUPT_OST6      - OST interrupt CBC6
//!  - EPWM_TZ_OST_INTERRUPT_DCAEVT1   - OST interrupt Digital compare event A1
//!  - EPWM_TZ_OST_INTERRUPT_DCBEVT1   - OST interrupt Digital compare event B1
//!
//! \return None.
//
//***************************************************************************
static inline void EPWM_clearOneShotTripZoneInterruptFlag(uint32_t base,
                                                uint16_t tzOSTIntFlags)
{
    ASSERT(EPWM_isBaseValid(base));
    ASSERT(tzOSTIntFlags < 0x800U);

    EALLOW;
    // Clear the Cycle By Cycle Trip zone interrupt flag
    HWREGH(base + EPWM_O_TZOSTCLR) |= tzOSTIntFlags;
...
//!
//! \param base is the base address of the EPWM module.
//! \param tzForceEvent is the forced Trip Zone interrupt.
//!
...
//!
//! \Note make sure the EPWM_enablePreInterruptEventCountLoad() function is
...
//! is 15.
//!
//! \Note Use this function in advanced ePWM interrupt count mode or if
//!       EPWM_setInterruptEventCount() function is called with the value of
//!       advScaleFlag set to true.
//!
//! \return None.
//
//*****************************************************************************
...
static inline uint16_t EPWM_getInterruptEventCount(uint32_t base)
{
    ...
    return(((HWREGH(base + EPWM_O_ETINTPS) >> 4U) & 0xFU));
}
                                     ...
                                     EPWM_AdcStartOfConversionType adcSocType)
{
    ...
    // enable an SOC
    if((uint16_t)adcSocType == EPWM_SOC_A)
    {
                                     ...
                                     EPWM_AdcStartOfConversionSource socSource)
{
    ...
    if(((uint16_t)socSource == EPWM_SOC_TBCTR_U_CMPC) ||
       ((uint16_t)socSource == EPWM_SOC_TBCTR_U_CMPD) ||
       ((uint16_t)socSource == EPWM_SOC_TBCTR_D_CMPC) ||
       ((uint16_t)socSource == EPWM_SOC_TBCTR_D_CMPD))
    {
    ...
    if((uint16_t)adcSocType == EPWM_SOC_A)
    {
        ...
        if(((uint16_t)socSource == EPWM_SOC_TBCTR_U_CMPA) ||
           ((uint16_t)socSource == EPWM_SOC_TBCTR_U_CMPB) ||
           ((uint16_t)socSource == EPWM_SOC_TBCTR_D_CMPA) ||
           ((uint16_t)socSource == EPWM_SOC_TBCTR_D_CMPB))
        {
            // Enable events based on comp A or comp B
            HWREGH(base + EPWM_O_ETSEL) &= ~EPWM_ETSEL_SOCASELCMP;
        }
        else if(((uint16_t)socSource == EPWM_SOC_TBCTR_U_CMPC) ||
                ((uint16_t)socSource == EPWM_SOC_TBCTR_U_CMPD) ||
                ((uint16_t)socSource == EPWM_SOC_TBCTR_D_CMPC) ||
                ((uint16_t)socSource == EPWM_SOC_TBCTR_D_CMPD))
        {
                                     ...
                                     EPWM_AdcStartOfConversionType adcSocType)
{
    ...
    return((((HWREGH(base + EPWM_O_ETFLG) >>
              ((uint16_t)adcSocType + 2U)) & 0x1U) == 0x1) ? true : false);
}
...
//!
//! \Note make sure the EPWM_enableADCTriggerEventCountInit()
                                     ...
                                     EPWM_AdcStartOfConversionType adcSocType)
{
    ...
    if((uint16_t)adcSocType == EPWM_SOC_A)
    {
        return(((HWREGH(base + EPWM_O_ETSOCPS) >>
                                ...
                                EPWM_DigitalCompareBlankingPulse blankingPulse)
{
    ...
    HWREGH(base + EPWM_O_DCFCTL) =
               ((HWREGH(base + EPWM_O_DCFCTL) & ~EPWM_DCFCTL_PULSESEL_M) |
                (((uint16_t)blankingPulse) << EPWM_DCFCTL_PULSESEL_S));
    EDIS;
}
                                  ...
                                  EPWM_DigitalCompareEventSource dcEventSource)
{
    ...
    EALLOW;
    if((uint16_t)dcEvent == EPWM_DC_EVENT_1)
    {
        HWREGH(base + registerOffset) =
...
static inline bool EPWM_getDigitalCompareCaptureStatus(uint32_t base)
{
    ...
    return((((HWREGH(base + EPWM_O_DCCAPCTL) >> 13U) & 0x1U) == 0x1) ?
            true : false);
}
...
//
//*****************************************************************************
static inline void EPWM_enableValleyHardwareDelay(uint32_t base)
{
    ASSERT(EPWM_isBaseValid(base));
                                            ...
                                            EPWM_ValleyCounterEdge edge)
{
    ...
    if((uint16_t)edge == EPWM_VALLEY_COUNT_START_EDGE)
    {
...
//!
//!   - EPWM_GL_LOAD_PULSE_CNTER_ZERO              - load when counter is equal
//!                                                  to zero
//!   - EPWM_GL_LOAD_PULSE_CNTER_PERIOD            - load when counter is equal
//!                                                  to period
//!   - EPWM_GL_LOAD_PULSE_CNTER_ZERO_PERIOD       - load when counter is equal
//!                                                  to zero or period
//!   - EPWM_GL_LOAD_PULSE_SYNC                    - load on sync event
//!   - EPWM_GL_LOAD_PULSE_SYNC_OR_CNTER_ZERO      - load on sync event or when
//!                                                  counter is equal to zero
//!   - EPWM_GL_LOAD_PULSE_SYNC_OR_CNTER_PERIOD    - load on sync event or when
//!                                                  counter is equal to period
//!   - EPWM_GL_LOAD_PULSE_SYNC_CNTER_ZERO_PERIOD  - load on sync event or when
//!                                                  counter is equal to period
//!                                                  or zero
...
//!
//! \param base is the base address of the EPWM module.
//! \param prescaleCount is the pulse event counts.
//!
//! This function sets the number of Global Load pulse events that have to
//! occurred before a global load pulse is issued. Valid values for prescaleCount
//! range from 0 to 7. 0 being no event (disables counter), and 7 representing
//! 7 events.
//!
//! \return None.
//
                                                      ...
                                                      uint16_t prescaleCount)
{
    ...
    HWREGH(base + EPWM_O_GLDCTL) =
                ((HWREGH(base + EPWM_O_GLDCTL) & ~EPWM_GLDCTL_GLDPRD_M) |
                 (prescaleCount << EPWM_GLDCTL_GLDPRD_S));
    EDIS;
}
...
//! occurred. These pulse events are set by the EPWM_setGlobalShadowLoadPulse()
//! function.
//!
//! \return None.
//
...
//! EPWM_setGlobalShadowLoadPulse() occurs.
//!
//! \return None.
//
//*****************************************************************************
...
//! EPWM_setGlobalShadowLoadPulse() occur , if the one shot global shadow load
//! option is enabled with EPWM_enableOSTGlobalShadowLoad() and if global
//! shadow load mode is enabled with EPWM_setupGlobalShadowLoadMode().
//!
//! \return None.
//
//*****************************************************************************
                                      ...
                                      EPWM_LockRegisterGroup registerGroup)
{
    ...
    HWREG(base + EPWM_O_LOCK) =
            ((uint32_t)0xA5A50000U |((uint32_t)1U << (uint16_t)registerGroup));
}
//*****************************************************************************
//
//! Set emulation mode
