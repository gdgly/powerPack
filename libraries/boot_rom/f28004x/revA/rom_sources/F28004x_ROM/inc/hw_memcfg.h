...
#ifndef __HW_MEMCFG_H__
#define __HW_MEMCFG_H__

//*****************************************************************************
//
// The following are defines for the MEMCONFIG register offsets
//
//*****************************************************************************
...
//
//*****************************************************************************
#define MEMCFG_DXLOCK_LOCK_D0     0x4U        // D0 RAM control fields lock
                                              // bit
#define MEMCFG_DXLOCK_LOCK_D1     0x8U        // D1 RAM control fields lock
                                              // bit
...
//
//*****************************************************************************
#define MEMCFG_DXCOMMIT_COMMIT_D0  0x4U        // D0 control fieldslock
#define MEMCFG_DXCOMMIT_COMMIT_D1  0x8U        // D1 control fieldslock
...
//
//*****************************************************************************
#define MEMCFG_LSXLOCK_LOCK_LS0   0x1U        // LS0 RAM control fields lock
                                              // fields lock bit
#define MEMCFG_LSXLOCK_LOCK_LS1   0x2U        // LS1 RAM control fields lock
                                              // fields lock bit
#define MEMCFG_LSXLOCK_LOCK_LS2   0x4U        // LS2 RAM control fields lock
                                              // fields lock bit
#define MEMCFG_LSXLOCK_LOCK_LS3   0x8U        // LS3 RAM control fields lock
                                              // fields lock bit
#define MEMCFG_LSXLOCK_LOCK_LS4   0x10U       // LS4 RAM control fields lock
                                              // fields lock bit
#define MEMCFG_LSXLOCK_LOCK_LS5   0x20U       // LS5 RAM control fields lock
                                              // fields lock bit
#define MEMCFG_LSXLOCK_LOCK_LS6   0x40U       // LS6 RAM control fields lock
                                              // fields lock bit
#define MEMCFG_LSXLOCK_LOCK_LS7   0x80U       // LS7 RAM control fields lock
                                              // fields lock bit
...
//
//*****************************************************************************
#define MEMCFG_LSXCOMMIT_COMMIT_LS0  0x1U        // LS0 control fieldslock
#define MEMCFG_LSXCOMMIT_COMMIT_LS1  0x2U        // LS1 control fieldslock
#define MEMCFG_LSXCOMMIT_COMMIT_LS2  0x4U        // LS2 control fieldslock
#define MEMCFG_LSXCOMMIT_COMMIT_LS3  0x8U        // LS3 control fieldslock
#define MEMCFG_LSXCOMMIT_COMMIT_LS4  0x10U       // LS4 control fieldslock
#define MEMCFG_LSXCOMMIT_COMMIT_LS5  0x20U       // LS5 control fieldslock
#define MEMCFG_LSXCOMMIT_COMMIT_LS6  0x40U       // LS6 control fieldslock
#define MEMCFG_LSXCOMMIT_COMMIT_LS7  0x80U       // LS7 control fieldslock
...
//
//*****************************************************************************
#define MEMCFG_GSXLOCK_LOCK_GS0   0x1U        // GS0 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS1   0x2U        // GS1 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS2   0x4U        // GS2 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS3   0x8U        // GS3 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS4   0x10U       // GS4 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS5   0x20U       // GS5 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS6   0x40U       // GS6 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS7   0x80U       // GS7 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS8   0x100U      // GS8 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS9   0x200U      // GS9 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS10  0x400U      // GS10 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS11  0x800U      // GS11 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS12  0x1000U     // GS12 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS13  0x2000U     // GS13 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS14  0x4000U     // GS14 RAM control fields lock
                                              // bit
#define MEMCFG_GSXLOCK_LOCK_GS15  0x8000U     // GS15 RAM control fields lock
                                              // bit
...
//
//*****************************************************************************
#define MEMCFG_GSXCOMMIT_COMMIT_GS0  0x1U        // GS0 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS1  0x2U        // GS1 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS2  0x4U        // GS2 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS3  0x8U        // GS3 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS4  0x10U       // GS4 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS5  0x20U       // GS5 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS6  0x40U       // GS6 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS7  0x80U       // GS7 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS8  0x100U      // GS8 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS9  0x200U      // GS9 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS10  0x400U      // GS10 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS11  0x800U      // GS11 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS12  0x1000U     // GS12 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS13  0x2000U     // GS13 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS14  0x4000U     // GS14 control fieldslock
#define MEMCFG_GSXCOMMIT_COMMIT_GS15  0x8000U     // GS15 control fieldslock
...
//
//*****************************************************************************
#define MEMCFG_ROMPREFETCH_PFDISABLE  0x1U        // ROM Prefetch Enable/Disable
                                              // Control
#endif
