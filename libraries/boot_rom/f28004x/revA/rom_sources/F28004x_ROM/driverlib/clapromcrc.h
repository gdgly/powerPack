...
#ifndef __CLAPROMCRC_H__
#define __CLAPROMCRC_H__
...
#if defined(__TMS320C28XX__) || defined(__TMS320C28XX_CLA2__)
//*****************************************************************************
//
...
//! The startAddress corresponding to the CLA is to be programmed used.
...
//! \param base is the base address of the CLAPROMCRC module.
//!
//! This function returns the current address of the data fetch unit.
//!
...
//! \param base is the base address of the CLAPROMCRC module.
//!
//! This function returns the status for the CLAPROMCRC.  Return value of false
//! means PASS.  Return value of true means FAIL.  The comparison is enabled
...
CLAPROMCRC_checkStatus(uint32_t base)
{
    ...
    // FAIL.
    //
    if((HWREG(base + CLAPROMCRC_O_CRC32_STATUSREG) &
...
//! \param base is the base address of the CLAPROMCRC module.
//!
//! This function returns the run status for the CLAPROMCRC with the base address
//! passed in the \e base parameter.  Return value of false means IDLE.  Return
//! value of true means ACTIVE.
//!
//! \return Returns true(Active) or false(Idle) as the run status of the CRC32
//! calculation.
//
//*****************************************************************************
static inline bool
...
CLAPROMCRC_getInterruptStatus(uint32_t base, CLAPROMCRC_IntFlag intFlag)
{
    ...
    //
    if((HWREGH(base + CLAPROMCRC_O_CRC32_FLG) & (uint16_t)intFlag ) ==
                    (uint16_t)intFlag)
    {
...
#endif // #if defined(__TMS320C28XX__) || defined(__TMS320C28XX_CLA2__)

#ifdef __TMS320C28XX__ // These functions can only be called from the C28x
//*****************************************************************************
//
//! Registers an interrupt handler CLAPROMCRC.
//!
//! \param base is the base address of the CLAPROMCRC module.
//! \param handler is a pointer to the function to be called when the
//! CLAPROMCRC done interrupt occurs.
//!
//! This function registers the handler to be called when an CLAPROMCRC
//! interrupt occurs.  This function enables the global interrupt in the
//! interrupt controller; specific CLAPROMCRC done interrupts must be enabled
//! via CLAPROMCRC_enableDoneInterrupt().  If necessary, it is the interrupt
...
//*****************************************************************************
//
//! Unregisters an interrupt handler for the CLAPROMCRC module.
//!
//! \param base is the base address of the CLAPROMCRC module.
//!
//! This function clears the handler to be called when an CLAPROMCRC interrupt
